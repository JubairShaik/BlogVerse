...
const stats = [
  { name: 'React Projects', value: '12+' },
  { name: 'years Experince', value: '12 Months+' },
  { name: 'in UI/UX', value: 'Specialist' }
  
];

export default function AboutMe() {
  return (
    <div className="relative isolate h-screen  overflow-hidden bg-gray-900 py-14 sm:py-32">
      <img
